...
export default function EquipmentTable({ plans }) {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-300">
        <thead>
          <tr>
            ...
            <th className="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">CPU</th>
            <th className="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Storage</th>
        ...
        <tbody>
          {plans.map((plan, planIdx) => (
            <tr key={plan.id}>
              ...
              <td className={classNames(planIdx === 0 ? '' : 'border-t border-gray-200', 'hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell')}>{plan.storage}</td>
